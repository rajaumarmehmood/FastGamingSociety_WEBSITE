...
//       Status: true // Assuming events added by President are automatically approved
//     });
//     setNewEventDetails({
//       name: '',
//       description: '',
...
//   const handleEditEvent = async (id, newDetails) => {
//     const eventDoc = doc(firestore, 'events', id);
//     await updateDoc(eventDoc, { 
//       name: newDetails.name,
//       description: newDetails.description,
//       RegisterationFee: newDetails.RegisterationFee,
//       WinningPrice: newDetails.WinningPrice,
//       societyId: newDetails.societyId
//     });
//     fetchEvents();
//   };
...
//             <td>
//               <button onClick={() => {
//                 const newTitle = prompt('Edit event title:', event.name);
//                 if (newTitle) {
//                   handleEditEvent(event.id, { ...event, name: newTitle });
//                 }
//               }}>
//                 Edit
//               </button>
            ...
            <td>
              {editEventId === event.id ? (
                <input
                  ...
                  onChange={(e) => setEditEventDetails({ ...editEventDetails, RegisterationFee: e.target.value })}
                />
              ) : (
